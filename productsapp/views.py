...
def product_detail(request,product_id):
    ...
    return render(request, 'product_detail.html',{'product':product,'saveds':saveds})
    ...
    if request.user==product.author:
        if request.method=='GET':
            ...
            if form.is_valid():
                ...
                return redirect('productsapp:detail',product.id)
            return render(request, 'product_update.html',{'form':form,'product':product})
    else:
...
def new_comment(request, product_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('productsapp:detail', product_id)
